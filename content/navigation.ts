export const labels = {
  ...
  "modal.deleteAnnouncement.title": "Delete announcement",
  "modal.deleteAnnouncement.description": "This cannot be undone. Students will no longer see it.",
  ...
  "action.addInstitute": "Add institute",
  "action.addSubject": "Add subject",
  "action.addAssignment": "New assignment",
  "action.addLesson": "New lesson",
  "action.addAnnouncement": "New announcement",
  "action.addInquiry": "New inquiry",
  ...
  "students.tags.empty": "No tags yet.",
  "students.tags.createTitle": "New tag",
  "students.tags.createAction": "Create tag",
  "students.tags.filter": "Tag",
  "students.tags.assign": "Tags",
  "students.institute.filter": "Institute",
  "students.institute.assign": "Institute",
  "institutes.createTitle": "New institute",
  "institutes.createAction": "Create institute",
  "modal.deleteTag.title": "Delete tag",
  "modal.deleteTag.description": "This removes the tag from all students.",
...
export const teacherNavItems: NavItem[] = [
  ...
  { href: "/teacher/institutes", labelKey: "nav.institutes" },
